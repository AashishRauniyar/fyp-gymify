...
class _UserTrainerPageState extends State<UserTrainerPage>
  ...
  void initState() {
    ...
    // Move initialization logic to initState to avoid setState during build
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _checkMembershipAndFetchData();
    });
  }

  // New method to check membership and fetch data
  Future<void> _checkMembershipAndFetchData() async {
    if (!_isMembershipChecked) {
      ...
      if (mounted) {
        ...
        if (membershipProvider.isActive || role == 'Trainer') {
  ...
  void didChangeDependencies() {
    ...
    // The initialization logic has been moved to initState with a post-frame callback
  }
