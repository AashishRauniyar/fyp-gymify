...
class _ExerciseLogScreenState extends State<ExerciseLogScreen>
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            Container(
              // Add some top padding to avoid status bar overlap
  ...
  Widget _buildExerciseInfo(Workoutexercise currentExercise, ThemeData theme) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Exercise header with expandable details
          ExpansionTile(
            tilePadding:
            ...
            leading: _buildExerciseImage(currentExercise, theme),
            title: Text(
            ...
            children: [
              // Exercise metrics in a more compact way
              Container(
                padding:
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildCompactMetric(
                      icon: Icons.timer,
                      value: '${currentExercise.duration ?? '0'}s',
                      label: 'Duration',
                      theme: theme,
                    ),
                    _buildCompactMetric(
          ...
          // Always visible description summary below the expandable section
          Padding(
            ...
            child: Column(
              ...
              children: [
                // Description preview
                if (currentExercise.exercises?.description != null &&
                    currentExercise.exercises!.description.isNotEmpty)
                  Container(
  ...
  // Helper method to generate a shortened tip from the description
  String _generateQuickTip(String description) {
    // If description is short enough, return as is
    if (description.length < 100) {
      return description;
    }

    // Look for the first sentence ending or first 100 chars
    ...
    // Otherwise return the first 100 chars with ellipsis
    return '${description.substring(0, 100)}...';
  }

  Widget _buildExerciseImage(Workoutexercise currentExercise, ThemeData theme) {
    return Container(
      width: 56,
      height: 56,
      decoration: BoxDecoration(
      ...
      child: currentExercise.exercises?.imageUrl != null &&
              currentExercise.exercises!.imageUrl.isNotEmpty
          ? ClipRRect(
              borderRadius: BorderRadius.circular(8),
              child: CachedNetworkImage(
                imageUrl: currentExercise.exercises!.imageUrl,
                fit: BoxFit.cover,
  ...
  Widget _buildRestActionButton(ThemeData theme) {
    // Changed color to match the app's accent color for better visibility
    return ElevatedButton.icon(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor:
            theme.colorScheme.primary, // Changed from secondary to tertiary
