...
class _ExerciseLogScreenState extends State<ExerciseLogScreen>
  ...
  //           // Improved instruction steps
  //           _buildImprovedInstructionSteps(
  //               currentExercise.exercises?.description ??
  //                   'No description available',
  //               theme),
  //         ],
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 6),
                    Text(
                      currentExercise.exercises?.targetMuscleGroup ?? 'N/A',
                      style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w600,
                        color: theme.colorScheme.primary,
  ...
  Widget _buildFormattedInstructions(String description, ThemeData theme) {
    // Split description into steps if possible
    final List<String> steps = description.split(RegExp(r'(?:\d+\.|\n|\r\n)'));
    final cleanedSteps = steps.where((s) => s.trim().isNotEmpty).toList();
    ...
    // Show as numbered list with better styling
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: theme.brightness == Brightness.dark
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          String step = cleanedSteps[index].trim();
  ...
  // // Improved exercise instructions display
  // Widget _buildImprovedInstructionSteps(String description, ThemeData theme) {
  //   // Split description into steps if possible
  //   final List<String> steps = description.split(RegExp(r'(?:\d+\.|\n|\r\n)'));
  //   final cleanedSteps = steps.where((s) => s.trim().isNotEmpty).toList();
