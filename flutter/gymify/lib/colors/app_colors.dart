...
// class AppColors {
//   // Light Theme Colors
//   static const Color lightPrimary = Color(0xFFFF5E3A);
...
class AppColors {
  ...
  static const Color lightPrimary =
      Color.fromARGB(255, 152, 115, 50); // Electric purple
