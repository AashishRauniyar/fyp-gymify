        ...
        await transporter.sendMail({
            ...
            html: `
                ...
                <body>
                    <div class="email-container">
                        <div class="email-header">
                            <h1>Welcome to the GYM💪, ${user_name}! Your membership have been approved</h1>
                        </div>
                        <div class="email-body">
                            <p> We're excited to have you on board, and we're here to support your fitness journey!</p>
                            <p>Your membership has been successfully approved. You can now access all the facilities and services we offer.</p>
                            <p>To get started, log in to your account and explore our features:</p>
                            <p>If you have any questions or need assistance, feel free to reach out to our support team.</p>
                            <p>Thank you for choosing Gymify!</p>
