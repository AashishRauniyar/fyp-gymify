...
const formSchema = z.object({
  ...
  current_weight: z.string().min(1, { message: "Current weight is required" }),
  fitness_level: z.enum(["Beginner", "Intermediate", "Advanced", "Athlete"], { 
    required_error: "Please select a fitness level" 
  }),
  goal_type: z.enum(["Weight_Loss", "Muscle_Gain", "Endurance", "Maintenance", "Flexibility"], { 
    required_error: "Please select a goal type" 
  }),
  allergies: z.string().optional(),
  calorie_goals: z.string().min(1, { message: "Calorie goal is required" }),
